							...
							<tbody>
								...
								<?php foreach ($file as $fs): ?>
									<tr>
										...
										<td class="text-dark"><?= $fs['ket_file']; ?></td>
										<td class="text-center  text-dark"><a class="btn btn-primary btn-sm" href="<?= base_url('assets/file/' . $fs['nama_file']); ?>"><i class="fa fa-download fa-fw"></i> Download</a></td>
									</tr>
									<?php $i++; ?>
								<?php endforeach ?>
							</tbody>
