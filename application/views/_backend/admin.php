                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-4">
                      <ul>
                        <li>
                          Fix Bug
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                        <li>
                        ...
                        <li>
                          Clean Footer And Structur Code
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                        <li>
                          Delete Field Slider 1-3
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                        <li>
                          Foto Kontributor 400px x 400px
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                        <li>
                          Logo 400px x 400px
                        ...
                        <li>
                          Thumbnail Berita 1256px x 843px
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                      </ul>
                    </div>
                    <div class="col-md-4">
                      <ul>
                        <li>
                          Delete Field Logo, Sub, dan Judul Icon
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                        <li>
                          Foto Profile 400px x 400px
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                        <li>
                          Ukuran Foto Sampul 753px x 506px
                          <sup><span class="badge badge-sm badge-primary">New</span></sup> 
                        </li>
                      </ul>
                    </div>
