						...
						<div class="col-lg-6 course_col">
							<div class="course">
								...
								<div class="course_body">
									<h3 class="course_title"><a href="<?= base_url('berita/post/' .  $value->slug_berita)  ?>"><?= substr(strip_tags($value->judul_berita),0,24); ?> ..</a></h3>
									<div class="course_teacher">Author: <?= $value->name  ?></div>
									<div class="course_text">
										<?= htmlspecialchars_decode(htmlspecialchars_decode(substr(strip_tags($value->isi_berita),0,100)))  ?> ... <a href="<?= base_url('berita/post/' .  $value->slug_berita)  ?>">Read More</a> 
									</div>
								</div>
