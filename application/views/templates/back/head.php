<html lang="en">
    <head>
        ...
        <link href="<?= base_url('assets/back/'); ?>css/metisMenu.min.css" rel="stylesheet">
         <!-- DataTables CSS -->
        <link href="<?= base_url('assets/back/'); ?>css/dataTables/dataTables.bootstrap.css" rel="stylesheet">
        <!-- DataTables Responsive CSS -->
        <link href="<?= base_url('assets/back/'); ?>css/dataTables/dataTables.responsive.css" rel="stylesheet">
        <!-- Custom CSS -->
