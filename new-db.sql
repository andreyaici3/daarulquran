...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2020 at 11:32 AM
...
CREATE TABLE `master_data_siswa` (
  ...
  `access_edit` varchar(2) NOT NULL,
...
INSERT INTO `master_data_siswa` (`id_siswa`, `nama_siswa`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `nik`, `jln`, `rt`, `rw`, `dusun`, `desa`, `kec`, `kota`, `prov`, `email`, `asal_sekolah`, `alamat_sekolah`, `email_sekolah`, `nama_guru_bp_bk`, `telp_hp`, `nama_ayah`, `tempat_lahir_ayah`, `tanggal_lahir_ayah`, `pendidikan_terakhir_ayah`, `pekerjaan_ayah`, `penghasilan_perbulan_ayah`, `hp_wa_ayah`, `nama_ibu`, `tempat_lahir_ibu`, `tanggal_lahir_ibu`, `pekerjaan_ibu`, `pendidikan_terakhir_ibu`, `penghasilan_perbulan_ibu`, `hp_wa_ibu`, `no_whatsapp`, `jenis_pendaftaran`, `username`, `password`, `status_akun`, `status_siswa`, `ijazah`, `access_edit`, `akta`, `kk`) VALUES
(2, 'Andrey Andriansyah', '', 'Kuningan', '2001-02-03', '089675677955', 'Wijaya Kusuma', '01', '02', 'Puhun', 'Cikubangmulya', 'Ciawigebang', 'Kuningan', 'jawa barat', 'andreyandri90@gmail.com', 'Smp Negeri 2 Ciawigebang', 'Desa Sukadana', 'smpn2ciawigebang@sch.id', 'Ukanda, S.Pd.', '085322202020', 'Sakib', 'Kuningan', '19041965', 'SD', 'Buruh Harian Lepas', '1500000', '085322087616', 'Ratminah', 'Kuningan', '24032001', 'Ibu RT', 'SMA', '-', '085322087616', '089675677955', 'ponpes', 'andriansyah758@daarulquran.com', '$2y$10$lO3UBY2SojRudKlPAoRoje5VlUZcWL2bCgPWVP2r/tujH6Hwbc3b2', '1', '0', '', '1', '2-persyaratan.pdf', ''),
(3, 'Tahrul Muttaqin', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '08965557745', 'ma', 'muttaqin521@daarulquran.com', '$2y$10$hrL9dgdGqmtXC8Y9gddkRuJ.iAYVJz4HqdW2neAqr0tmZULAqtP/C', '0', '0', '', '1', '', '');
